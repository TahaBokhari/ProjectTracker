...
public class updateProjectfromAllProjects extends javax.swing.JFrame {
    ...
    public updateProjectfromAllProjects() throws SQLException {
    ...
    private void initComponents() {
        ...
        jPanel3.add(updateProject, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 720, 250, -1));
...
//                updateProjectfromAllProjects obj=new updateProjectfromAllProjects();
//                obj.setVisible(true);
                
//                rs.close();
                FilterProjects obj=new FilterProjects();
                obj.setVisible(true);
                this.dispose();
...
//        rs.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateProjectfromAllProjects.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new updateProjectfromAllProjects().setVisible(true);
