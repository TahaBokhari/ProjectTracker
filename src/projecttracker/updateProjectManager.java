...
public class updateProjectManager extends javax.swing.JFrame {
    ...
    public updateProjectManager() throws SQLException {
...
//        theDir.mkdir();
            ...
            Logger.getLogger(updateProjectManager.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        rs.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateProjectManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new updateProjectManager().setVisible(true);
